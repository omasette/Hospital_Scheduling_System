               ...
               <form method="post" action="doctor_update.php">
				...
				<div class="row">
						   ...
						   <div class="form-group">
							<label for="date">Phone Number</label>
								...
								<select class="form-control select2" name="rank" required>
									<option><?php echo $row['member_number'];?></option>
								  <?php 
									$query2=mysqli_query($con,"select * from rank order by number")or die(mysqli_error($con));
									  while($row2=mysqli_fetch_array($query2)){
								  ?>
                  ...
                  <button class="btn btn-lg btn-primary" id="daterange-btn" name="save" type="submit">
					  ...
					  <a class="btn btn-lg btn-default " id="daterange-btn" href="doctor.php">
                       Cancel
                      </a>
