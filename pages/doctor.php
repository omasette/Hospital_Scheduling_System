...
<html>
  ...
  <body class="hold-transition skin-yellow layout-top-nav" onload="myFunction()">
        ...
        <div class="container">
	      ...
	      <div class="col-md-9">
              <div class="box box-warning">
               <form method="post" id="reg-form" action="doctor_save.php">
                <div class="box-body">
				<div class="row">
					<div class="col-md-12">
    ...
    ?>
                ...
                <td>
                  <a id="click" href="doctor_edit.php?id=<?php echo $id;?>">
                    <i class="glyphicon glyphicon-edit text-blue"></i></a>
                  <a id="removeme" href="doctor_del.php?id=<?php echo $id;?>">
						  ...
						  <div class="form-group">
						   ...
						   <div class="form-group">
							<label for="date">Phone Number</label>
								<input type="number" class="form-control" name="rank" placeholder="+254 *********" required>
